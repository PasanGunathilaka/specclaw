---
description: Run the propose → plan → build → verify lifecycle autonomously across the queue of active changes. Requires automation config in config.yaml. Use to advance every change to its next phase; not for a single targeted change.
---
