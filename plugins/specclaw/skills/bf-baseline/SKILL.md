---
description: Design, generate and record the golden-master harness that proves a rebuild behaves identically to the legacy app — ranking seams, deriving scenarios from domain-model.md's rules, and validating captured fixtures into manifest.json. Run in the legacy repo after /specclaw:bf-domain.
---
